#include "HJRootListController.h"

@implementation HJRootListController
...
- (void)generate_map:(id)sender {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"HiddenJailbreak" message:@"Processing packages..." preferredStyle:UIAlertControllerStyleAlert];
